      ...
      <div className="max-w-2xl w-full flex flex-col items-center text-center gap-10">
        ...
        <div className="w-full max-w-md">
          <a
            ...
            className="flex items-center justify-center gap-3 rounded-xl bg-white text-black font-medium text-base px-6 py-4 transition-all hover:bg-white/90 active:scale-[0.98]"
          >
        ...
        <p className="font-inter text-sm text-[#A1A1AA]">
          Also available on{" "}
          <a href="https://github.com/DanisChaparov/aztrx" target="_blank" rel="noopener" className="text-[#3B82F6] underline">GitHub Releases</a>
